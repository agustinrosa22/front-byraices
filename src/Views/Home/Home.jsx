        ...
        <div className={style.container}>
            <div className={style.intro}>
                ...
                <div className={style.buttonsContainer}>
                    <button className={style.button} onClick={() => window.location.href = '/buy'}>Comprar</button>
                    <button className={style.button} onClick={() => window.location.href = '/alquilar'}>Alquilar</button>
                    <button className={style.button} onClick={() => window.location.href = '/sell'}>Vender</button>
                    <button className={style.button} onClick={() => window.location.href = '/emprendimientos'}>Desarrollos</button>
                </div>
