...
import './CardProperty.module.css';
import foto1 from '../../images/foto1.jpg';
import foto2 from '../../images/foto2.jpg';
import logoByraices from '../../images/fotoLogo.webp';
...
const Property = () => {
  return (
    <div>
      ...
      <div style={{ position: 'relative', marginBottom: '100px', overflow: 'hidden' }}>
        <div className="main-content" style={{ position: 'relative', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', margin: '0 auto', maxWidth: '1200px', marginBottom: '100px' }}>
          <div className="left-panel" style={{ flex: '0 0 25%', position: 'relative', zIndex: 1, marginRight: '150px' }}>
            <img src={foto1} alt="Left Image" style={{ width: '450px', height: '350px', objectFit: 'cover' }} />
          </div>
          <div className="center-panel" style={{ position: 'absolute', top: '50px', left: '50%', transform: 'translate(-50%)', zIndex: 2, width: '50%', minWidth: '600px', height: '500px' }}>
            <div style={{ backgroundColor: 'rgba(169, 169, 169, 0.5)', padding: '10px', borderRadius: '10px' }}>
              <Card>
                <Card.Body>
          ...
          <div className="right-panel" style={{ flex: '0 0 25%', position: 'relative', zIndex: 1, marginLeft: '150px' }}>
